        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Soft-deleted companies that can be restored or permanently removed</p>
                </div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 p-4 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-lg flex items-center gap-3">
                ...
                <span class="text-sm font-medium text-amber-700 dark:text-amber-300">These companies are archived. You can restore or permanently delete them.</span>
            </div>
                                    ...
                                    <div class="flex gap-2 flex-shrink-0">
                                        ...
                                        <div x-data="{ open: false }">
                                            ...
                                            <x-confirm-action-modal
                                                name="force-delete-{{ $company->id }}"
                                                title="Permanently Delete?"
                                                message="This action cannot be undone. The company and all its data will be permanently removed."
                                                :action="route('companies.forceDelete', $company)"
                                                method="delete"
