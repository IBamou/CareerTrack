...
<head>
    ...
    <title>404 - Page Not Found - {{ config('app.name', 'CareerTrack') }}</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 120px; font-weight: 700; color: #2563eb; line-height: 1; margin-bottom: 8px; }
...
<body>
    <div class="card">
        ...
        <p class="desc">The page you are looking for does not exist or has been moved.</p>
