        ...
        <div class="max-w-3xl mx-auto space-y-6">
            <form method="POST" action="{{ route('interviews.update', $interview) }}" class="space-y-6">
                ...
                <div class="flex gap-3 justify-end">
                    <a href="{{ route('interviews.show', $interview) }}" class="inline-flex items-center px-5 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl font-medium text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        Cancel
                    </a>
                    <x-primary-button>
